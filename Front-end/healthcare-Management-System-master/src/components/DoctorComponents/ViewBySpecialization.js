...
class ViewBySpecialization extends Component {
    ...
    componentDidMount() {
        ...
        this.props.onGetdoctorbyspecialization(this.props.specialization);
    }
    view(id) {
    ...
    render() {
        ...
        return (
            <div className="container shadow-lg p-4 pt-3 bg-white text-dark border border-secondary rounded">
                <h1 className="mx-auto text-center" > DOCTORS BY SPECIALIZATION </h1>
...
const mapStateToProps = (state,ownProps) => {
    ...
    return {
                    ...
                    specialization: ownProps.match.params.specialization
    }
}
...
export default connect(mapStateToProps,mapDispatchToProps) (ViewBySpecialization)